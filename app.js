document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
      { "id": 1, "name": "منتج 1", "price": 100, "image": "images/product-1.jpg" },
      { "id": 2, "name": "منتج 2", "price": 150, "image": "images/product-2.jpg" },
      { "id": 3, "name": "منتج 3", "price": 200, "image": "images/product-3.jpg" },
      { "id": 4, "name": "منتج 4", "price": 120, "image": "images/product-4.jpg" },
      { "id": 5, "name": "منتج 5", "price": 180, "image": "images/product-5.jpg" },
      { "id": 6, "name": "منتج 6", "price": 250, "image": "images/product-6.jpg" },
      { "id": 7, "name": "منتج 7", "price": 130, "image": "images/product-7.jpg" },
      { "id": 8, "name": "منتج 8", "price": 160, "image": "images/product-8.jpg" },
      { "id": 9, "name": "منتج 9", "price": 220, "image": "images/product-9.jpg" },
      { "id": 10, "name": "منتج 10", "price": 190, "image": "images/product-10.jpg" },
      { "id": 11, "name": "منتج 11", "price": 110, "image": "images/product-11.jpg" },
      { "id": 12, "name": "منتج 12", "price": 280, "image": "images/product-12.jpg" }
    ];
    ...
    // Always update the cart count on every page load
    updateCartCount();
});
